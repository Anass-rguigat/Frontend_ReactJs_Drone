    ...
    >
      ...
      >
        ...
        <h1 className="text-2xl sm:text-4xl lg:text-5xl font-extrabold mb-6 leading-tight">
          Drones pour l'Aménagement du Territoire et l'Évaluation Post-Sinistre
        </h1>
        <p className="max-w-xl text-gray-200 text-sm md:text-base mb-8">
          Utilisez la puissance des drones pour évaluer les zones sinistrées et planifier l'aménagement du territoire après des catastrophes naturelles. Nos technologies de drones offrent une vue d'ensemble précise et rapide pour soutenir vos projets.
        </p>
            ...
            >
              <div className="w-full aspect-video">
                <iframe
                  width="100%"
                  height="100%"
                  src="https://www.youtube.com/embed/7oL2-oGkIBo"
                  title="YouTube video"
                  frameBorder="0"
