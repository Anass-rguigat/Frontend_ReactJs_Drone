...
const FirstSection = () => {
  ...
  return (
    <motion.div
      ...
      style={{
        backgroundImage: `url('https://www.dronettoyage.fr/wp-content/uploads/2024/01/drone-nettoyage-panneaux-solaires-1.jpg')`,
      }}
    ...
    >
      ...
      >
        ...
        <h1 className="text-2xl sm:text-4xl lg:text-5xl font-extrabold mb-6 leading-tight">
          Démoussage et Nettoyage par Drone
        </h1>
        <p className="max-w-xl text-gray-200 text-sm md:text-base mb-8">
          Optimisez le nettoyage de vos surfaces avec des drones pulvérisateurs. Idéal pour les façades, couvertures ou panneaux photovoltaïques, notre service est économique, sécurisé et respectueux de l'environnement.
        </p>
            ...
            >
              <div className="w-full aspect-video">
                <iframe
                  width="100%"
                  height="100%"
                  src="https://www.youtube.com/embed/5k2772pOkFI"
                  title="YouTube video"
                  frameBorder="0"
